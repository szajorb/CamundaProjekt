...
public void sendCertyficateOfRecovery(final JobClient client, final ActivatedJob job, @ZeebeVariable String person_uuid, @ZeebeVariablesAsType String recovery_certyficate_uuid){
